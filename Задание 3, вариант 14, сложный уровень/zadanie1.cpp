...
int main()
{
    ...
    // первое вхождение заданного символа. В условии написано: ...дана СТРОКА... - поэтому используется string.
    // ВАЖНО!
    // Готовые функции для удаления заданного символа - не используются. От string используется только append для посимвольного формирования новой строки.
    std::cout << "Номер 4_1" << std::endl;
    std::string input = "String string string";
    std::string output = ex3::deleteFirstOccurrence(input, 't');
